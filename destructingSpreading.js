...
for (const { name, scores, skills, age } of usersWithLessThanTwoSkills) {
  console.log('name:', name);
  console.log('scores:', scores);
  console.log('skills:', skills);
  console.log('age:', age);
...
console.log(`${name} (${numberOfSkills}) ${JSON.stringify(skills)} ${jsScore} ${reactScore}`);
...
// Copy the student1 object to newStudent without mutating the original object. In the new object add the following?
