...
const unionAB = findUnion(a, b);
console.log("Union of arrays a and b:", unionAB);
...
const intersectionAB = findIntersection(a, b);
console.log("Intersection of arrays a and b:", intersectionAB);

// Find a with b
function findRelativeComplement(arr1, arr2) {
    const complement = arr1.filter(value => !arr2.includes(value));
    
    return complement;
}
const complementAB = findRelativeComplement(a, b);
console.log("Relative complement of a with respect to b:", complementAB);
...
const stringSet = new Set(slicedArray);
console.log(stringSet);

// Create a map of countries and number of characters of a country
function createCountryCharMap(countriesArray) {
    const countryCharMap = {};

    countriesArray.forEach(country => {
        countryCharMap[country.name] = country.name.length;
    });

    return countryCharMap;
}
const countryCharCountMap = createCountryCharMap(countries);
console.log(countryCharCountMap);

// How many languages are there in the countries object file
function countUniqueLanguages(countriesArray) {
...
function findMostSpokenLanguages(countriesArray) {
    ...
    const sortedLanguages = Object.keys(languageCounts).map(language => ({
        language: language,
        count: languageCounts[language]
    })).sort((a, b) => b.count - a.count);
    return sortedLanguages.slice(0, 10);
}
const mostSpokenLanguages = findMostSpokenLanguages(countries);
